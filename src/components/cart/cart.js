                  ...
                  <React.Fragment>
                    ...
                    <div className="total-container">
                      <div className="d-flex justify-content-between">
                        ...
                        <p className="text-right p2">
                          <strong>{priceWithDots(value.cartTotal)} VND</strong>
                        </p>
                      </div>
                      <button
                        className="btn btn-primary btn-md clear-btn"
                        onClick={() => value.clearCart()}
                      >
                        Clear
                      </button>
                    </div>
                    <button className="btn btn-primary btn-lg payment-btn">
                      Payment
                    </button>
                  </React.Fragment>
                );
